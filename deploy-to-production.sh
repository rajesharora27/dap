...
echo ""
echo "✨ New Features in this deployment (v3.9.0):"
echo "  • ✅ NEW: Detailed User Login Statistics (Individual Records)"
echo "  • ✅ NEW: Robust Entity Change Logging (Auto Name Lookup)"
echo "  • ✅ NEW: Comprehensive Audit Logging for Tags & Core Entities"
echo "  • ✅ FIXED: User Attribution in Audit Logs (Historical & New)"
echo ""
