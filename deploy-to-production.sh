...
echo ""
echo "✨ New Features in this deployment (v3.6.0):"
echo "  • ✅ NEW: Solution Adoption Plan Full Sync & Filters"
echo "  • ✅ NEW: Metadata Table Task Counts (Inclusive)"
echo "  • ✅ NEW: Consistent Blue/Green Icon Scheme"
echo "  • ✅ NEW: Recursive Progress Bar Updates"
echo "  • ✅ FIXED: Solution Task License Resolver & Filtering"
echo ""
