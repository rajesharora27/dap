...
const CREATE_PRODUCT = gql`
  mutation CreateProductSeeder($input: ProductInput!) {
    createProduct(input: $input) { id name resources { label url } }
  }
`;

const CREATE_SOLUTION = gql`
  mutation CreateSolutionSeeder($input: SolutionInput!) {
    createSolution(input: $input) { id name resources { label url } }
  }
`;
    ...
    products: [
      {
        ...
        resources: [{ label: "Overview", url: "https://example.com/ecommerce" }],
        customAttrs: {
      ...
      },
      {
        ...
        resources: [{ label: "Documentation", url: "https://example.com/banking" }],
        customAttrs: {
      ...
      {
        name: "CRM System",
        resources: [{ label: "Guide", url: "https://example.com/crm" }],
        customAttrs: {
      ...
      },
      {
        ...
        resources: [{ label: "Analytics", url: "https://example.com/analytics" }],
        customAttrs: {
          category: "Analytics",
    ...
    solutions: [
      {
        ...
        resources: [{ label: "Overview", url: "https://example.com/suite" }],
        customAttrs: {
          industry: "Enterprise",
          deployment: "Cloud",
          duration: "12 months"
      ...
      },
      {
        ...
        resources: [{ label: "Package Docs", url: "https://example.com/finance" }],
        customAttrs: {
          industry: "Finance",
      ...
      },
      {
        ...
        resources: [{ label: "Modernization Tips", url: "https://example.com/retail" }],
        customAttrs: {
          industry: "Retail",
