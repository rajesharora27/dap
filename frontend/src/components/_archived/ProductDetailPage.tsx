    ...
    <Box>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 3, ml: 3, borderLeft: '4px solid #1976d2' }}>
        ...
        {tasksLoading ? (
          ...
          <TableContainer>
            {(() => {
              console.log('🎨 MODERNIZED ProductDetailPage rendering tasks:', tasks.length);
                  ...
                  <Card sx={{ 
                    ...
                    <CardContent sx={{ pb: 1 }}>
                      <Box display="flex" justifyContent="space-between" alignItems="start">
                        <Box flex="1">
                          {/* Task name with inline HowTo chips */}
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap', mb: 1 }}>
                            ...
                            {task.howToDoc && task.howToDoc.length > 0 && (
                              <Chip
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  if (Array.isArray(task.howToDoc)) {
                            ...
                            {task.howToVideo && task.howToVideo.length > 0 && (
                              <Chip
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  if (Array.isArray(task.howToVideo)) {
