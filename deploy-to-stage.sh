...
echo ""
echo "✨ New Features in this deployment (v2.10.0):"
echo "  • ✅ FIXED: Telemetry Export Template now pre-fills existing values correctly"
echo "  • ✅ UI REFRESH: Consistent visual theming for Direct (Green) vs Solution (Blue) products"
echo "  • ✅ UI REFRESH: Updated Product icons (Widgets) and Solution icons (Link)"
echo "  • ✅ UI REFRESH: Standardized flattened icon styles and button colors"
echo "  • ✅ IMPROVED: Portfolio Scorecard typography and Product List layout"
echo ""
