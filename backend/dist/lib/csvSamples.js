...
exports.TASK_SAMPLE_CSV = exports.PRODUCT_SAMPLE_CSV = void 0;
exports.generateProductSampleCsv = generateProductSampleCsv;
exports.generateTaskSampleCsv = generateTaskSampleCsv;
exports.validateProductHeaders = validateProductHeaders;
exports.validateTaskHeaders = validateTaskHeaders;
exports.PRODUCT_SAMPLE_CSV = `id,name,description,statusPercent
...
exports.TASK_SAMPLE_CSV = `id,name,description,estMinutes,weight,sequenceNumber,licenseLevel,priority,notes,licenseId,outcomeIds
...
function generateProductSampleCsv() {
    return exports.PRODUCT_SAMPLE_CSV;
}
function generateTaskSampleCsv() {
    return exports.TASK_SAMPLE_CSV;
}
/**
 * Validate CSV headers for products
 */
function validateProductHeaders(headers) {
    const required = ['name'];
 ...
 */
function validateTaskHeaders(headers) {
