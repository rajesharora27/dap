    ...
    Mutation: {
        ...
        async createSampleData(_, __, { prisma }) {
            try {
                ...
                context_1.logger.info(`Created ${createdCount} sample products`);
                return {
                    success: true,
